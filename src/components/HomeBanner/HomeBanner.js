...
const HomeBanner = () => {
	return (
		<section id="hero" className="relative bg-cover bg-no-repeat isolate" style={{backgroundImage: `url(${bannerImage})`}}>
			...
			<div className="container min-h-screen text-center flex flex-col items-center justify-center isolate pt-32 pb-14">
				...
				<a href="#about" rel="nofollow" className="btn-outline mt-6 h-20">
					More
